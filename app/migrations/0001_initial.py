# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2018-03-26 19:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('block', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.BlocksData')),
            ],
        ),
        migrations.CreateModel(
            name='Civilians',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('block', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.BlocksData')),
            ],
        ),
        migrations.CreateModel(
            name='Stocks',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='assigned_shelter', to='app.Shelter'),
        ),
        migrations.AddField(
            model_name='civilians',
            name='block',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='app.BlocksData'),
        ),
        migrations.AddField(
            model_name='civilians',
